...
def makeplot(rs, ps, outDir, class_name, iou_type, ax):
    ...
    fig = ax.get_figure()
    fig.savefig(outDir + '/PR_curve_FN0.5.png', dpi=300)
    plt.close(fig)
    return aps[0]
...
def makebarplot(rs, ps, outDir, class_name, iou_type):
    ...
    ax.set_xticks(x)
    ax.set_xticklabels(areaNames, fontsize=16, fontname='Times New Roman')
...
# --ann=//Users//wuzhongze//Documents//中南大学科研//2023论文发表//2023论文//2023TII//数据集//solar_cell_EL_image_coco_data_process_last3//annotations//instances_val2017.json
