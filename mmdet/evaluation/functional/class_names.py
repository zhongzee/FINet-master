...
def coco_classes():
   ...
   """
    ...
    #     'scissors', 'teddy_bear', 'hair_drier', 'toothbrush'
    # ]
    return ["crack", "finger", "black_core", "thick_line", "star_crack", "corner", "fragment", "scratch", "horizontal_dislocation",
         "vertical_dislocation", "printing_error", "short_circuit"]
    # return ['Annealed_black_spot', 'EL_etched_edge', 'Mayan_pitting', 'EL_cloud', 'SE_Offset', 'Annealing_fouling', 'EL_roller_print',
